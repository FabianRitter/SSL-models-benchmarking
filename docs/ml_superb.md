...
| Date | Track | Command | Result | Label |
|---|---|---|---|---|
| 2026-07-19 | mono10min xty | `run_wavlm_mlsuperb1.sh --track mono10min --lang xty` | test CER 62.1 % (93 utts / 11,277 chars; Corr 49.4, Del 29.9, Ins 11.5) | **FULL** (recipe-default schedule; ~20 min on 1×H100) |

> No published WavLM ML-SUPERB row exists; treat CERs as first WavLM numbers for this benchmark, sanity-checked against the recipe's HuBERT-Base anchors only.

### Mono10min FULL sweep (2026-07-19/20, recipe-default schedule, ~20 min/lang on 1xH100)

| Lang | test CER % | | Lang | test CER % |
|---|---|---|---|---|
| deu1 | 31.5 | | fra1 | 49.1 |
| swe | 33.0 | | fra2 | 51.4 |
| rus | 34.8 | | xty | 62.1 |
...
> deu1 31.5 vs the recipe's HuBERT-Base anchor 35.1 — WavLM Base+ improves on it. eng1/2/3+cmn hit a
> recipe data-prep crash on blank transcript lines (`single_lang_data_prep.py` unpack error); jpn needs
> the g2p extras. Fixes: strip blank lines from the staged transcripts (data-side), install pyopenjtalk/pypinyin.

**Track complete (2026-07-20, all 13 languages):** eng1 31.2 / eng2 41.2 / eng3 33.2 CER; cmn 42.8 / jpn 17.8 PER (word-scored per run_mono.sh convention); plus the 8 CERs above. WavLM Base+ beats the recipe's HuBERT-Base anchors (eng1 31.2 vs 33.8; jpn 17.8 vs 20.6). eng1-3/cmn needed a data-side blank-line fix in swc/eng transcripts; jpn/cmn needed pyopenjtalk/pypinyin.
